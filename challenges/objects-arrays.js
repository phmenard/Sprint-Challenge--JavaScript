...
console.log(`When called, return "RAWERSRARARWERSARARARRRR!"`);
...
const contactInfo = ['Josh', 'josh@example.com'];
...
let findUni = function(item, index){
  if (item.search('Uni') !== -1){
    unisWithUni.push({'University': item});
  }

  //return {'University': item};
  
}
universities.forEach(findUni);
...
let getNames = function(item, index){
